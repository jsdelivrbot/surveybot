...
//   log.info(payload, 'successful login');

//   if (!payload.identity.team_id) return log('something went wrong', payload);

//   let team = {};
//   try {
//     team = await util.promisify(controller.storage.teams.get)(payload.identity.team_id);
//   } catch(err) {
//     log.info({err: err, ...payload}, 'could not get team');
//   } finally {
//     const finalTeam = _.merge(team, payload);
//     finalTeam.id = finalTeam.team_id;
//     await util.promisify(controller.storage.teams.save)(finalTeam);
//   }
// }
